...
test('generator serve', { skip: !generatorFns.length }, function (t) {
...
test('async serve', { skip: !asyncFns.length }, function (t) {
...
test('async generator serve', { skip: asyncGenFns.length === 0 }, function (t) {
